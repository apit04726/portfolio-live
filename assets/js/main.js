...
(function() {
   ...
   * Header toggle
   */
  const headerToggleBtn = document.getElementById('mobile-menu-toggle');
  function headerToggle() {
    const header = document.getElementById('header');
    header.classList.toggle('header-show');
    // Animate bars
    const bars = headerToggleBtn.querySelectorAll('.toggle-bar');
  ...
  document.querySelectorAll('.isotope-layout').forEach(function(isotopeItem) {
    ...
    if (container) {
      ...
      console.warn('Isotope container not found for:', isotopeItem);
    }
    ...
    isotopeItem.querySelectorAll('.isotope-filters li').forEach(function(filters) {
      filters.addEventListener('click', function() {
        ...
        if (initIsotope && typeof initIsotope.arrange === 'function') {
          ...
          console.warn('Isotope not initialized yet or arrange is not a function.');
        }
